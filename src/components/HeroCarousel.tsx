  ...
  const slides = [
    {
      ...
      icon: <GraduationCap className="w-12 h-12 md:w-16 md:h-16 text-white mb-4" />,
    ...
    },
    {
      ...
      icon: <BookOpen className="w-12 h-12 md:w-16 md:h-16 text-white mb-4" />,
    ...
    },
    {
      ...
      icon: <Award className="w-12 h-12 md:w-16 md:h-16 text-white mb-4" />,
    ...
    },
    {
      ...
      icon: <Users className="w-12 h-12 md:w-16 md:h-16 text-white mb-4" />,
    ...
    },
    {
      ...
      icon: <Star className="w-12 h-12 md:w-16 md:h-16 text-white mb-4" />,
              ...
              <div className={`min-h-[500px] md:min-h-[600px] bg-gradient-to-br ${slide.background} flex items-center justify-center px-4 py-8`}>
                <div className="container mx-auto">
                  <div className="text-center max-w-4xl mx-auto text-white">
                    ...
                    <p className="text-base md:text-xl mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed text-white/80 px-2">
                      {slide.description}
                    </p>
                    ...
                    <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-6 md:mb-8 px-2">
                      {slide.features.map((feature, index) => (
                        <div key={index} className="bg-white/20 backdrop-blur-sm rounded-full px-3 py-2 md:px-4 md:py-2">
                    ...
                    <Button 
                      size="lg" 
                      className="bg-white text-gray-900 hover:bg-gray-100 text-base md:text-lg px-6 py-4 md:px-8 md:py-6 font-semibold"
